...
#include "../../SecRTC/inlcude/maintabwidget.h"
...
struct qt_meta_stringdata_MainTabWidget_t {
    QByteArrayData data[1];
    char stringdata0[14];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_MainTabWidget_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_MainTabWidget_t qt_meta_stringdata_MainTabWidget = {
    {
QT_MOC_LITERAL(0, 0, 13) // "MainTabWidget"
...
const QMetaObject MainTabWidget::staticMetaObject = {
    { &QTabWidget::staticMetaObject, qt_meta_stringdata_MainTabWidget.data,
      qt_meta_data_MainTabWidget,  qt_static_metacall, nullptr, nullptr}
};
...
void *MainTabWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_MainTabWidget.stringdata0))
